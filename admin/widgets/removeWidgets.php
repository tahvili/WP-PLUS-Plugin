...
if(isset($wp_plusOptions['wp_plus_chk_dashBoxes']) && $wp_plusOptions['wp_plus_chk_dashBoxes'] == 1){

} else {

        function wp_plus_admin_remove_dashboard_meta() {
...
add_action( 'admin_init', 'wp_plus_admin_remove_dashboard_meta' );
